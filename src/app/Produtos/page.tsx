...
export default function () {
  return(
    ...
    <div className="border-4 border-yellow-500 p-8 bg-[#141310] flex flex-col items-center justify-center">
      <div>
        <h1 className="text-3xl font-bold text-center "> Nosso Pack de Produtos </h1>
      </div>
